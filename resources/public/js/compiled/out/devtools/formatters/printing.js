...
var len__26126__auto___29682 = arguments.length;
var i__26127__auto___29683 = (0);
while(true){
if((i__26127__auto___29683 < len__26126__auto___29682)){
args__26133__auto__.push((arguments[i__26127__auto___29683]));

var G__29684 = (i__26127__auto___29683 + (1));
i__26127__auto___29683 = G__29684;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29679){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__29680,G__29681,seq29679__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29685_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__29685_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__29694__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29698){var e__27204__auto__ = e29698;
return false;
}})();
if(cljs.core.truth_(or__25051__auto__)){
return or__25051__auto__;
...
}catch (e29700){var e__27204__auto__ = e29700;
return false;
}}
})())){
...
var _STAR_current_state_STAR_29705 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__29706 = opts;
...
var markup_db = cljs.core.get.call(null,map__29706__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_29705;
}});
...
;
var temp__4655__auto___29711 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___29711)){
var managed_print_level_29712 = temp__4655__auto___29711;
var _STAR_print_level_STAR_29710_29713 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_29712;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_29710_29713,managed_print_level_29712,temp__4655__auto___29711,writer,opts,job_fn){
return (function (p1__29708_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__29708_SHARP_,null);
});})(_STAR_print_level_STAR_29710_29713,managed_print_level_29712,temp__4655__auto___29711,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_29710_29713;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1485966383289
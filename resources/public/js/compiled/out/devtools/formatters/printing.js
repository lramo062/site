...
var len__25865__auto___36743 = arguments.length;
var i__25866__auto___36744 = (0);
while(true){
if((i__25866__auto___36744 < len__25865__auto___36743)){
args__25872__auto__.push((arguments[i__25866__auto___36744]));

var G__36745 = (i__25866__auto___36744 + (1));
i__25866__auto___36744 = G__36745;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq36740){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__36741,G__36742,seq36740__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__36746_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__36746_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__36755__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e36759){var e__35920__auto__ = e36759;
return false;
}})();
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
...
}catch (e36761){var e__35920__auto__ = e36761;
return false;
}}
})())){
...
var _STAR_current_state_STAR_36766 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__36767 = opts;
...
var markup_db = cljs.core.get.call(null,map__36767__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_36766;
}});
...
;
var temp__4655__auto___36772 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___36772)){
var managed_print_level_36773 = temp__4655__auto___36772;
var _STAR_print_level_STAR_36771_36774 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_36773;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_36771_36774,managed_print_level_36773,temp__4655__auto___36772,writer,opts,job_fn){
return (function (p1__36769_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__36769_SHARP_,null);
});})(_STAR_print_level_STAR_36771_36774,managed_print_level_36773,temp__4655__auto___36772,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_36771_36774;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1484878889024
...
var G__29641 = devtools.prefs.pref.call(null,v);
v = G__29641;
continue;
} else {
return v;
...
}catch (e29654){var e__27204__auto__ = e29654;
return false;
}})();
...
}catch (e29658){var e__27204__auto__ = e29658;
return false;
}})();
...
}catch (e29660){var e__27204__auto__ = e29660;
return false;
}}
}
});
...
var vec__29665 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__29665,(0),null);
var name = cljs.core.nth.call(null,vec__29665,(1),null);
...
return cljs.core.some.call(null,(function (p1__29668_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29668_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1485503012469
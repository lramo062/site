...
var G__36702 = devtools.prefs.pref.call(null,v);
v = G__36702;
continue;
} else {
return v;
...
}catch (e36715){var e__35920__auto__ = e36715;
return false;
}})();
...
}catch (e36719){var e__35920__auto__ = e36719;
return false;
}})();
...
}catch (e36721){var e__35920__auto__ = e36721;
return false;
}}
}
});
...
var vec__36726 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__36726,(0),null);
var name = cljs.core.nth.call(null,vec__36726,(1),null);
...
return cljs.core.some.call(null,(function (p1__36729_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__36729_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1484878888945
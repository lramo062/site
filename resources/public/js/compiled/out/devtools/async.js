...
var o__27179__auto___30164 = (function (){var o__27179__auto__ = (function (){var o__27179__auto__ = Promise;
return goog.object.get(o__27179__auto__,"resolve").call(o__27179__auto__);
})();
return goog.object.get(o__27179__auto__,"then").call(o__27179__auto__,callback);
})();
goog.object.get(o__27179__auto___30164,"catch").call(o__27179__auto___30164,devtools.async.rethrow_outside_promise);
...
var G__30166_30167 = Error;
var target__27198__auto___30168 = G__30166_30167;
if(cljs.core.truth_(target__27198__auto___30168)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__30166_30167)].join('')),cljs.core.str("\n"),cljs.core.str("target__27198__auto__")].join('')));
}

goog.object.set(target__27198__auto___30168,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1485966383995
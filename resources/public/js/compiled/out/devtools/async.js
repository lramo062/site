...
var o__35895__auto___37456 = (function (){var o__35895__auto__ = (function (){var o__35895__auto__ = Promise;
return goog.object.get(o__35895__auto__,"resolve").call(o__35895__auto__);
})();
return goog.object.get(o__35895__auto__,"then").call(o__35895__auto__,callback);
})();
goog.object.get(o__35895__auto___37456,"catch").call(o__35895__auto___37456,devtools.async.rethrow_outside_promise);
...
var G__37458_37459 = Error;
var target__35914__auto___37460 = G__37458_37459;
if(cljs.core.truth_(target__35914__auto___37460)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__37458_37459)].join('')),cljs.core.str("\n"),cljs.core.str("target__35914__auto__")].join('')));
}

goog.object.set(target__35914__auto___37460,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1484878889599
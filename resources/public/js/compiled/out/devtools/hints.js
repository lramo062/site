...
}catch (e37482){var _e = e37482;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___37485 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___37485)){
var seen_errors_37486 = temp__4655__auto___37485;
if(cljs.core.truth_(seen_errors_37486.has(self))){
} else {
seen_errors_37486.add(self);

var temp__4657__auto___37487 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___37487)){
var sense_37488 = temp__4657__auto___37487;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_37488)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1484878889662
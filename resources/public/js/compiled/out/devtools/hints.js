...
var file = cljs.core.get.call(null,map__30191__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__30191__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__30191__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e30190){var _e = e30190;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___30193 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___30193)){
var seen_errors_30194 = temp__4655__auto___30193;
if(cljs.core.truth_(seen_errors_30194.has(self))){
} else {
seen_errors_30194.add(self);

var temp__4657__auto___30195 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___30195)){
var sense_30196 = temp__4657__auto___30195;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_30196)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1485503012998
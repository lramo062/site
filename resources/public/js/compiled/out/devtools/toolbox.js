...
var args37195 = [];
var len__25865__auto___37201 = arguments.length;
var i__25866__auto___37202 = (0);
while(true){
if((i__25866__auto___37202 < len__25865__auto___37201)){
args37195.push((arguments[i__25866__auto___37202]));

var G__37203 = (i__25866__auto___37202 + (1));
i__25866__auto___37202 = G__37203;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox37198 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox37198 = (function (obj,header,style,tag,meta37199){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox37198.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37200,meta37199__$1){
var self__ = this;
var _37200__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox37198(self__.obj,self__.header,self__.style,self__.tag,meta37199__$1));
});

devtools.toolbox.t_devtools$toolbox37198.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37200){
var self__ = this;
var _37200__$1 = this;
return self__.meta37199;
});

devtools.toolbox.t_devtools$toolbox37198.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox37198.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox37198.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox37198.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox37198.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta37199","meta37199",1236560266,null)], null);
});

devtools.toolbox.t_devtools$toolbox37198.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox37198.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox37198";

devtools.toolbox.t_devtools$toolbox37198.cljs$lang$ctorPrWriter = (function (this__25396__auto__,writer__25397__auto__,opt__25398__auto__){
return cljs.core._write.call(null,writer__25397__auto__,"devtools.toolbox/t_devtools$toolbox37198");
});

devtools.toolbox.__GT_t_devtools$toolbox37198 = (function devtools$toolbox$__GT_t_devtools$toolbox37198(obj__$1,header__$1,style__$1,tag__$1,meta37199){
return (new devtools.toolbox.t_devtools$toolbox37198(obj__$1,header__$1,style__$1,tag__$1,meta37199));
});

}

return (new devtools.toolbox.t_devtools$toolbox37198(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1484878889435